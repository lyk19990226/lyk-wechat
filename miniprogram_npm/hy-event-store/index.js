...
__DEFINE__(1646136598406, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646136598407,"./event-store":1646136598408}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646136598407, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646136598408, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646136598407,"./utils":1646136598409}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646136598409, function(require, module, exports) {
...
return __REQUIRE__(1646136598406);
})()
